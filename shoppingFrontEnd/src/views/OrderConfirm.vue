      ...
      <div class="item-list-wrap confirm-item-list-wrap">
        <div class="cart-item order-item">
          ...
          <ul class="cart-item-list">
            <li v-for="item in checkCartList">
...
export default {
    ...
    computed:{
      subtotal(){
         return this.checkCartList.reduce((accumulator,currentValue)=>{
  ...
  methods:{
      init(){
          axios.get('/users/checkCartList').then(res=>{
              if(res.data.status===1){
                  this.checkCartList=res.data.result;
              }
          })
      },
      payment(){
        ...
        axios.post('users/payment',{
          ...
          if(res.data.status===0){
            this.$router.push('/orderSuccess?orderId='+res.data.result.orderId)
          }
        })
      },
      reload(){
